...
L["Knockbacks"] = "Rückstoßeffekte" -- Needs reviews
...
local spellsAndProvidersByCategory = {
	...
	incapacitate = {
		...
		[203337] = true, -- Diamond Ice (added by bicmex)
		-- Mage
		[   118] = true, -- Polymorph
		...
		[391622] = true, -- Polymorph (duck, added by bicmex)
		[321395] = true, -- Polymohph (mawrat, added by bicmex)
		[383121] = true, -- Mass Sheep (added by bicmex)
		[460396] = true, -- Polymorph (mosswool, added by bicmex)
		[461489] = true, -- Polymorph (protosheep, added by bicmex)
		...
		[269352] = true, -- Hex (skeletal hatchling, added by Bicmex)
		[277778] = true, -- Hex (zandalari tendonripper, added by Bicmex)
		[277784] = true, -- Hex (wicker mongrel, added by Bicmex)
		[309328] = true, -- Hex (living honey, added by Bicmex)
		-- Warlock
		[   710] = true, -- Banish
    ...
    [   605] = true, -- Dominate Mind
		...
		[316593] = true, -- Intimidating Shout (Talent)
	},
	...
	root = {
		...
		[454787] = true, -- ice prison (added by bicmex)
		-- Druid
		[   339] = true, -- Entangling Roots
		[ 235963] = true, -- physical roots
