...
function Auras:CreateFrame(unit)
	...
	if not self.buffFrame[unit] and Gladius.db.aurasBuffs then
		...
		for i = 1, 40 do
			...
			self.buffFrame[unit][i]:SetNormalTexture("Interface\\AddOns\\Gladius_Updated_by_sammers\\Images\\Gloss")
	...
	if not self.debuffFrame[unit] and Gladius.db.aurasDebuffs then
		...
		for i = 1, 40 do
			...
			self.debuffFrame[unit][i]:SetNormalTexture("Interface\\AddOns\\Gladius_Updated_by_sammers\\Images\\Gloss")
