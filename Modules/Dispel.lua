...
function Dispel:COMBAT_LOG_EVENT_UNFILTERED(event)
	...
	if eventType == "SPELL_DISPEL" then
		...
		if spellId == 527 or spellId == 4987 or spellId == 77130 or spellId == 88423 or spellId == 115450 or spellId == 2782 or spellId == 51886 or spellId == 475 or spellId == 360823 then
	...
	if Gladius.db.dispellGridStyleIcon then
		...
		if not testing then
			...
			elseif englishClass == "EVOKER" then
			    dispellIcon = "Interface\\Icons\\ability_evoker_fontofmagic_green" -- OK
			end
		else
			if unit == "arena1" then
